...
import 'package:ungsales/widget/signin.dart';
import 'package:ungsales/widget/signup.dart';
...
Future<Null> checkLogin()async{
    ...
    if (firebaseUser != null) {
      ...
      await firestore.collection('User').document(uid).snapshots().listen((event) {
  ...
  ListTile signInMenu() {
    return ListTile(
      ...
      title: Text('Sign In'),
      subtitle: Text('การลงชื่อเข้าใช้งาน'),
      onTap: () {
